...
//----------------------------------
  ...
  Serial.println(String("VOLTAGE 4 : ") + String(Voltage0, 2) + " V");
  delay(500);
  
  tft.setCursor(170, 130);      //xpos, ypos
  tft.print(String(Voltage1, 2) + " V");
  Serial.println(String("VOLTAGE 4 : ") + String(Voltage1, 2) + " V");
  delay(500);
  

  tft.setCursor(170, 160);      //xpos, ypos
  tft.print(String(Voltage2, 2) + " V");
  Serial.println(String("VOLTAGE 4 : ") + String(Voltage2, 2) + " V");
  delay(500);
